...
В игре есть возможность играть с друзьями на одном устройстве, ведь с друзьями интереснее. 
...
- Любая ОС (зависит от поддержуи Pygame)
- RAM 4-8 ГБ
...
- Хотелось ещё сделать побольше объектов для совместного прохождения (рычаги и т.д.), и камеру, ну и конечно побольше уровней.

## Ресурсы

### Шрифты:

- Pixeloid_font_0_4 (от https://www.ggbot.net/fonts/)
